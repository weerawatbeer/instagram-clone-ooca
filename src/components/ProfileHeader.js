...
const ProfileHeader = ({ profile, countPosts }) => {
  const history = useHistory();
      ...
      <Wrapper>
        ...
        <div className="profile-info">
          ...
          <div className="profile-stats">
            <span>{countPosts && countPosts} posts</span>

            <span className="pointer">{followersState} followers</span>

            <span className="pointer">{profile?.followingCount} following</span>
